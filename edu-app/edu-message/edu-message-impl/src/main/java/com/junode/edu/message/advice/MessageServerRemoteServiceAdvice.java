package com.junode.edu.message.advice;

import javax.servlet.http.HttpServletResponse;

import com.junode.edu.message.exception.MessageServerException;
...
import com.junode.edu.common.util.EnvironmentUtils;
...
public class MessageServerRemoteServiceAdvice {
    ...
    @Pointcut("execution(* com.junode.edu.message.controller..*.*(..))")
