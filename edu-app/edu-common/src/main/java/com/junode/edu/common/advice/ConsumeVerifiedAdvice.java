package com.junode.edu.common.advice;
...
import com.junode.edu.common.annotation.ConsumeVerified;
...
public class ConsumeVerifiedAdvice {
    private static final Logger log = LoggerFactory.getLogger(ConsumeVerifiedAdvice.class);
	
	@Autowired
	private RedisTemplate<String, String> redisTemplate;

    @Pointcut("@annotation(com.junode.edu.common.annotation.ConsumeVerified)")
