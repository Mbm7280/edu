package com.junode.edu.gateway.filter;

import com.junode.edu.gateway.service.IPermissionService;
import com.junode.edu.auth.client.service.IAuthService;
 ...
 */
@Configuration
@ComponentScan(basePackages = "com.junode.edu")
