package com.junode.edu.order.advice;
...
import com.junode.edu.order.service.IUserCourseOrderRecordService;
...
public class UserCourseOrderRecordAdvice {
    ...
    @Pointcut("@annotation(com.junode.edu.order.annotation.UserCourseOrderRecord)")
     ...
     */
    com.junode.edu.order.entity.UserCourseOrderRecord buildUserCourseOrderRecord(String orderNo, Integer fromStatus, Integer toStatus){
    	com.junode.edu.order.entity.UserCourseOrderRecord saveUserCourseOrderRecord = new com.junode.edu.order.entity.UserCourseOrderRecord();
