package com.junode.edu.pay.advice;
...
import com.junode.edu.pay.api.enums.OperationType;
...
public class PayOrderRecordAdvice {
    ...
    @Pointcut("@annotation(com.junode.edu.pay.annotation.PayOrderRecord)")
     ...
     */
    com.junode.edu.pay.entity.PayOrderRecord buildPayOrderRecord(String orderNo, BigDecimal amount, Integer fromStatus, Integer toStatus, OperationType type) {
    	com.junode.edu.pay.entity.PayOrderRecord savePayOrderRecord = new com.junode.edu.pay.entity.PayOrderRecord();
		savePayOrderRecord.setCreatedAt(new Date());
    	savePayOrderRecord = new com.junode.edu.pay.entity.PayOrderRecord();
		savePayOrderRecord.setCreatedAt(new Date());
