...
public class CallBackReq implements Serializable {
	...
	public String getWxCallBackReqStr() {
		return wxCallBackReqStr;
	}

	public void setWxCallBackReqStr(String wxCallBackReqStr) {
		this.wxCallBackReqStr = wxCallBackReqStr;
	}

	public Map<String, String> getAliParams() {
		return aliParams;
	}

	public void setAliParams(Map<String, String> aliParams) {
